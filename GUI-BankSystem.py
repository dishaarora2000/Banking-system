...
#transfer cash
def transfer_crdt_write(master,amt,accnt,name):
...
def transfer_debit_write(master,amt,accnt,accnt1,nm):
    ...
    if(int(amt)>camt):
        ...
        frec.write(str(strftime("[%Y-%m-%d] [%H:%M:%S]",gmtime()))+"\t"+str(0)+"\t"+str(amti)+"\t"+str(cb)+"\n")
        frec.close()
        transfer_crdt_write(master,amt,accnt1,nm)
...
def Cr_Amt(accnt,name):
	...
	l_title=tk.Message(creditwn,text="My Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
...
def De_Amt(accnt,name):
	...
	l_title=tk.Message(debitwn,text="My Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","30","bold"))
	l_title.pack(side="top")
...
def disp_bal(accnt):
	...
	l_title=tk.Message(disp,text="My Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","30","bold"))
	l_title.pack(side="top")
	fdet=open(accnt+".txt",'r')
	fdet.readline()
...
def disp_tr_hist(accnt):
    ...
    l_title=tk.Message(disp_wn,text="My Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
...
def transfer1(accnt):
	...
	l_title=tk.Message(transfer,text="My Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def logged_in_menu(accnt,name):
	...
	rootwn.title("My Bank-"+name)
	rootwn.configure(background='#8AAEC6')
	fr1=tk.Frame(rootwn)
	fr1.pack(side="top")
	
	l_title=tk.Message(rootwn,text="My Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def log_in(master):
	...
	l_title=tk.Message(loginwn,text="My Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Create():
	...
	l_title=tk.Message(crwn,text="My Bank",relief="raised",width=2000,padx=600,pady=0,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
...
def Main_Menu():
	...
	x.place(x=0,y=0)
	l_title=tk.Message(text="My Bank",relief="raised",width=2000,padx=600,pady=-10,fg="white",bg="#C21807",justify="center",anchor="center")
	l_title.config(font=("Courier","50","bold"))
	l_title.pack(side="top")
	myFont = font.Font(family='Helvetica', size=20, weight='bold')
